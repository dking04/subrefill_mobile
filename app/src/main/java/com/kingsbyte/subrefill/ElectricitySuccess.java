...
public class ElectricitySuccess extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electricity_success);
        Intent intent = getIntent();
        String tokencode = intent.getStringExtra("tokencode");
        ...
        msgTxt.setText("Token: "+tokencode);

        closeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new Dashboard().onRefreshBalance(ElectricitySuccess.this);
                finish();
            }
        });
        ...
        buyAgainBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ElectricitySuccess.this,Electricity.class);
